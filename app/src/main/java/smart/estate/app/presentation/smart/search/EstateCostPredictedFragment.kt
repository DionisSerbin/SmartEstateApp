 ...
 * Use the [EstateCostPredictedFragment.newInstance] factory method to
...
class EstateCostPredictedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EstateCostPredictedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EstateCostPredictedFragment().apply {

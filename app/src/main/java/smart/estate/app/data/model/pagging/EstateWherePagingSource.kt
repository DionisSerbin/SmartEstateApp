...
class EstateWherePagingSource(private val apiRepository: ApiRepository, private val estateFilters: EstateFilters) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Estate> {
        return try {
            ...
            return withContext(Dispatchers.IO) {
                val response = apiRepository.getEstatesWhere(
